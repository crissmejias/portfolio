...
return(
    <section className="dark:border-white w-10/12 md:w-1/2 my-4 h-98 md:h-5/6 rounded-lg mx-auto bg-[#EAEDFB] shadow-lg shadow-[#695858] border-black border-[1px] dark:bg-gray-700 flex flex-col items-center justify-start gap-8 flex-wrap py-4">
        <div className="mx-auto">
            ...
            <p className='dark:text-white text-lg mt-4 mx-8 text-center'>Here you will find some of my personal projects and blogs I've posted about Frontend Development.</p>
        </div>
        <div className="w-1/2">
            <h2 className="text-center text-3xl dark:text-white font-bold">My Stack</h2>
        </div>
        ...
        <div className="mt-4 w-1/2 mx-auto flex flex-col gap-8">
            <h2 className="text-center text-3xl dark:text-white font-bold">My Interests</h2>

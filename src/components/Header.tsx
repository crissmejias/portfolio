...
const Header = () => {
    ...
    return(
        <header className={`w-full flex items-center justify-between   dark:border-gray-200 bg-[#E5D4CE] border-black border-[1px] m-[0.5px] dark:bg-gray-700 flex-col md:flex-row`}>            
                ...
                <div className="w-12 h-6 bg-[#C06868]  peer-focus:outline-none rounded-full peer dark:peer-checked:bg-gray-200 peer-checked:after:translate-x-full  peer-checked:after:border-white after:content-[''] after:absolute  after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600"></div>
            </label>

    ...
    return(
        ...
        <div className=" w-11/12 md:max-h-[450px]  mt-4 mx-auto bg-gray-700 rounded-lg border-2 border-gray-200 opacity-[35]">
            ...
            <div className=" my-2 flex  flex-col items-baseline gap-2">
                ...
                <a href="https:/github.com/crissmejias" className='text-[#fff] hover:text-gray-500 transition-colors  text-center inline-block m-auto' target="_blank"><i className='fi fi-brands-github' ></i> crissmejias</a>
                <a href="https:/twitter.com/crissmejias"className='text-[#fff] hover:text-gray-500 transition-colors  text-center inline-block m-auto' target="_blank"><i className='fi fi-brands-twitter'></i> @crissmejias</a>

...
const Card = (props : props) => {
    return(
        ...
        <div style={{ backgroundImage: `url(${props.url})`
          }} className={`"w-full min-h-[400px] flex flex-col items-center justify-between flex-wrap p-4 rounded-xl dark:bg-inherit bg-[#EAEDFB] hover:shadow-lg hover:shadow-[#695858] border-black border-[1px]  group bg-blend-darken bg-center bg-[length:100%_auto] bg-no-repeat dark:hover:bg-gray-500 transition-colors`}>
